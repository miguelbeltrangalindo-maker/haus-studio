      ...
      <div className="dash-hero">
        ...
        {(totalAnticipo > 0 || totalRestante > 0) && (
          <div className="dash-hero-money">
            ...
            {totalAnticipo > 0 && totalRestante > 0 && <span style={{ color: 'var(--text3)' }}>·</span>}
      ...
      <div style={{ padding: '12px 16px 0' }}>
        <div className="home-grid" style={{ gap: 10 }}>
          ...
          >
            ...
            <div>
              <div className="menu-card-label" style={{ color: '#fff', fontSize: 15 }}>Nueva sesión</div>
              <div className="menu-card-sub" style={{ color: 'rgba(255,255,255,0.75)' }}>Agendar cliente</div>
            </div>
          </button>
        </div>
      </div>
